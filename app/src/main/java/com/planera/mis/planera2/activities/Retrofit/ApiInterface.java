...
public interface ApiInterface {
    ...
    Call<MainResponse> addTerritory(@Header("Authorization") String token, @Query("Name") String name, @Query("StateId") int stateId);

    @GET(AppConstants.ADD_GIFT)
    Call<MainResponse> addGift(@Header("Authorization") String token, @Query("Name") String gift);

    @GET(AppConstants.ADD_PATCH)
    Call<MainResponse> addPatch(@Header("Authorization") String token, @Query("Name") String patch, @Query("TerritoryId") int territoryId);

    @GET(AppConstants.ADD_PRODUCTS)
    Call<MainResponse> addProduct(@Header("Authorization") String token, @Query("Name") String name, @Query("IsBrand") int isBrand);


    @POST(AppConstants.ADD_DOCTORS)
    Call<DoctorResponse>  addDoctor(@Header("Authorization") String token, @Body Doctors doctors);
    ...
    Call<MainResponse> deleteGift(@Header("Authorization") String token, @Query("GiftId") int giftId);

    @GET(AppConstants.DELETE_TERRITORY)
    Call<MainResponse> deleteTerritory(@Header("Authorization") String token, @Query("TerritoryId") int territoryId);

    @GET(AppConstants.DELETE_PATCH)
    Call<MainResponse> deletePatch(@Header("Authorization") String token, @Query("PatchId") int patchId);

    @GET(AppConstants.DELETE_DOCTORS)
    Call<MainResponse> deleteDoctor(@Header("Authorization") String token, @Query("DoctorId") int doctorId);
    ...
    Call<MainResponse> updateTerritoryDetails(@Header("Authorization") String token, @Query("TerritoryId") int territoryId, @Query("StateId") int stateId, @Query("Name") String name);

    @POST(AppConstants.UPDATE_DOCTOR)
    Call<MainResponse> updateDoctorDetails(@Header("Authorization") String token, @Body Doctors doctors);

    @GET(AppConstants.UPDATE_PRODUCT)
    Call<MainResponse> updateProductDetails(@Header("Authorization") String token, @Query("ProductId") int productId, @Query("IsBrand") String isBrand, @Query("Name") String name);

    @GET(AppConstants.UPDATE_PATCH)
    Call<MainResponse> updatePatchDetails(@Header("Authorization") String token, @Query("PatchId") int patchId, @Query("Name") String name, @Query("TerritoryId") int territoryId);
